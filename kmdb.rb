...
# Add Warner Bros to the studios table 
new_studio = Studio.new
new_studio["name"] = "Warner Bros."
new_studio.save

# Create an association to include in the movies table 
...
# Populate the roles table -- Batman Begins
new_role = Role.new
...
# Populate the roles table -- The Dark Knight
new_role = Role.new
...
# Populate roles table - The Dark Knight Rises
new_role = Role.new
